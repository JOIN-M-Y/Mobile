        ...
        child: Column(
          ...
          children: <Widget>[
              ...
              children: <Widget>[
                ...
                InkWell(
                    child: Container(
                      ...
                      child: ClipRect(
                        child: Image.asset(
                          'images/ic_white_arrow_left.png', width: 32,
                          height: 32,),
                      ),
                    )),
                Container(
                  margin: EdgeInsets.only(top: width - 10, left: 28),
            ...
            Padding(
              ...
              child: Text("강남구 ∙ 평일오후 3주", style: TextStyle(
                  fontSize: 14, color: Color.fromRGBO(211, 211, 211, 1))),
            ),
            Container(
            ...
            Container(
                margin: const EdgeInsets.only(top: 29, left: 28, right: 28),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text("활동계획", style: TextStyle(color: Colors.white,
                        fontSize: 15,
                    ...
                    Container(margin: const EdgeInsets.only(top: 8),
                        child: Text(
                            ...
                            style: TextStyle(
                                ...
                                fontSize: 13))),
                    SizedBox(height: 36),
                    Text("스터디 모집 기간", style: TextStyle(color: Colors.white,
                        fontSize: 15,
                        fontWeight: FontWeight.bold)),
                    Container(margin: const EdgeInsets.only(top: 8),
                        child: Text(
                            "2020. 02. 14 - 2020. 02. 22 까지",
                            style: TextStyle(
                                color: Color.fromRGBO(211, 211, 211, 1),
                                fontSize: 13)))
                  ],
